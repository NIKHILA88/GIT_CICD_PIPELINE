...
tree /opt/splunk/current/etc/deployment-apps/$index_inputs
tree /opt/splunk/current/etc/deployment-apps/$index_props
...
sudo -u splunk /opt/splunk/current/bin/splunk reload deploy-server $index
